...
Public Class FrmPrincipal
    ...
    Private Sub FrmPrincipal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        TsBarraInferior.Text = "Usuario: " & Nombre
        ...
        ElseIf (Me.Rol = "Almacenero") Then
            ...
            Dim frmA As New FmrMenuAlmacenero
            frmA.MdiParent = Me
            frmA.Show()
        ...
        ElseIf (Me.Rol = "Vendedor") Then
            ...
            Dim frmV As New FmrMenuVendedor
            frmV.MdiParent = Me
            frmV.Show()
    ...
    Private Sub SalirToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SalirToolStripMenuItem.Click
        If (MsgBox("Estas Seguro que quienes salir?", vbYesNo + vbQuestion, "Sistema") = vbYes) Then
            End
        End If
    End Sub
