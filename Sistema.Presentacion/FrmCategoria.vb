Public Class FrmCategoria
    ...
    Private Sub TxtNombre_Validating_1(sender As Object, e As System.ComponentModel.CancelEventArgs)
        If DirectCast(sender, TextBox).Text.Length > 0 Then
            Me.ErrorIcono.SetError(sender, "")
        Else
            Me.ErrorIcono.SetError(sender, "Ingrese el nombre de la categoria porfavor, dato obligatorio")
        End If
    End Sub
    ...
    Private Sub BtnInsertar_Click_1(sender As Object, e As EventArgs) Handles BtnInsertar.Click
        If Me.ValidateChildren = True And TxtNombre.Text <> "" Then
            ...
            If (Neg.Insertar(Obj)) Then
                ...
                Me.Listar()
            Else
                MsgBox("No se ha completado el registro", vbOKOnly + vbCritical, "Registro Incorrecto")
            End If
    ...
    Private Sub BtnActualizar_Click(sender As Object, e As EventArgs) Handles BtnActualizar.Click
        If Me.ValidateChildren = True And TxtNombre.Text <> "" And TxtId.Text <> "" Then
            ...
            If (Neg.Actualizar(Obj)) Then
                ...
                TabGeneral.SelectedIndex = 0
            Else
                MsgBox("No se ha actualizado el registro", vbOKOnly + vbCritical, "Actualización Incorrecta")
            End If
    ...
    Private Sub ChkSeleccionar_CheckedChanged_1(sender As Object, e As EventArgs)
    ...
    Private Sub DgvListado_CellContentClick_1(sender As Object, e As DataGridViewCellEventArgs)
        If e.ColumnIndex = DgvListado.Columns.Item("Seleccionar").Index Then
            Dim chkcell As DataGridViewCheckBoxCell = DgvListado.Rows(e.RowIndex).Cells("Seleccionar")
            chkcell.Value = Not chkcell.Value
        End If
    ...
    Private Sub BtnActivar_Click_1(sender As Object, e As EventArgs) Handles BtnActivar.Click
    ...
    Private Sub BtnDesactivar_Click_1(sender As Object, e As EventArgs) Handles BtnDesactivar.Click
